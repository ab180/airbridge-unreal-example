...
public class AirbridgeContentProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        try {
            ...
            if (loadLibrary)
                builder.setOnAttributionResultReceiveListener(new UEOnAttributionResultReceiveListener());
            
            Airbridge.init(app, builder.build());
        } catch (Throwable throwable) {
            Log.e("Airbridge Unreal Engine", "Couldn't initialize SDK", throwable);
        }
        return true;
    }
